...
///
public func == (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .equals, value: value)
}

/// Builds an inequality filter: `.filter("state" != 0)`.
public func != (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .notEquals, value: value)
}

/// Builds a greater-than filter: `.filter("quantity" > 5)`.
public func > (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .greaterThan, value: value)
}

/// Builds a greater-than-or-equal filter.
public func >= (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .greaterThanOrEquals, value: value)
}

/// Builds a less-than filter.
public func < (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .lessThan, value: value)
}

/// Builds a less-than-or-equal filter.
public func <= (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .lessThanOrEquals, value: value)
}

/// Builds a contains filter: substring on strings, membership on lists.
public func ~~ (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .contains, value: value)
}

/// Builds a prefix filter: `.filter("name" =~ "cart_")`.
public func =~ (field: String, value: RecordValue) -> EntityStore.Filter {
    EntityStore.Filter(field: field, op: .beginsWith, value: value)
}
