...
public func == (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .equals, value: value))
}
...
///
public func != (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .notEquals, value: value))
}
...
///
public func > (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .greaterThan, value: value))
}
...
///
public func >= (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .greaterThanOrEquals, value: value))
}
...
///
public func < (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .lessThan, value: value))
}
...
///
public func <= (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .lessThanOrEquals, value: value))
}
...
///
public func ~~ (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .contains, value: value))
}
...
///
public func =~ (field: String, value: RecordValue) -> FilterExpression {
    FilterExpression(ClientFilter(field: field, op: .beginsWith, value: value))
}
