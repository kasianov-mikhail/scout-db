...
| 🔐 | **Security** | Client-side field encryption, filterable hashed surrogates, and trusted-writer filtering for public databases. |
| 📎 | **Records** | Entity references with cascading delete. |
